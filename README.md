...
A traditional chess engine built in C, designed to be **understandable, transparent, and easy to learn from**. No neural networks, no black boxes, no "Unified Theory of Slightly Better Bishops heuristic" bullsh\*\*tery. Just pure chess logic you can understand and modify.
